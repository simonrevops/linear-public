...
export default function AdminPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-[#ededed] mb-2">Admin Console</h1>
        <p className="text-[#9ca3af]">Manage public projects and monitor the Linear portal.</p>
      </div>
      ...
      {/* Instructions */}
      <div className="mt-8 bg-[#151515] border border-[#1f1f1f] rounded-lg p-6">
